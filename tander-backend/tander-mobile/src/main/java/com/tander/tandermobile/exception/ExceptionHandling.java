...
import com.tander.tandermobile.domain.http.response.HttpResponse;
...
import static com.tander.tandermobile.exception.constant.ExceptionConstant.*;
...
public class ExceptionHandling implements ErrorController {
    ...
    */
     ...
     * @return ResponseEntity and generic credentials error message to prevent username enumeration.
     */
    ...
    /**
     * Handles RegisterNotFoundException when no registration data is provided.
     *
     * @param exception the RegisterNotFoundException thrown when register data is missing.
     * @return ResponseEntity status and register not found error message.
     */
    @ExceptionHandler(RegisterNotFoundException.class)
    public ResponseEntity<HttpResponse> registerNotFoundException(RegisterNotFoundException exception) {
        return createHttpResponse(BAD_REQUEST, exception.getMessage());
    }
    /**
     * Handles ProfileIncompleteException when user attempts to login without completing profile registration.
     *
     * @param exception the ProfileIncompleteException thrown when profile is incomplete.
     * @return ResponseEntity status and profile incomplete error message.
     */
    @ExceptionHandler(ProfileIncompleteException.class)
    public ResponseEntity<HttpResponse> profileIncompleteException(ProfileIncompleteException exception) {
    ...
    public ResponseEntity<HttpResponse> notFoundException(NoResultException exception) {
        LOGGER.error("No result found in database", exception);
    ...
    public ResponseEntity<HttpResponse> iOException(IOException exception) {
        LOGGER.error("Error occurred while processing file", exception);
